    ...
    return ( 
        <section className='text-center bg-blue-700 h-fit py-8'>
            ...
            <form action={searchProperty}>
                <input type='text' placeholder='Enter location(City,State,Zip,etc)' className='bg-white p-2 rounded-lg text-xs md:text-sm md:w-1/5' name='location' required/>
                <select className='bg-white p-2 rounded-lg text-xs mx-4  w-fit md:text-sm' name='type'>
